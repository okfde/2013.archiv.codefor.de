...
author: Eileen & Fiona
excerpt: Im Ulmer Verschwörhaus haben sich die Labs auf einen Wikidata-Hackathon Anfang Dezember getroffen.
images:
...
Im Ulmer Verschwörhaus haben sich die Labs auf einen Wikidata-Hackathon Anfang Dezember getroffen. Wikidata, das ist die Knowledge Base hinter der beliebtesten Internet-Enzyklopädie Wikipedia. Es geht also um offene Daten, die von Ehrenamtlichen eingefügt, verlinkt und geprüft werden, und gleichzeitig von allen benutzt werden können. Nach einer Einführung in die Query-Sprache von Wikidata – SPARQL – wurden gleich viele Fragen in Form von Querys verfasst. Hier sind unsere Lieblingsquerys:
